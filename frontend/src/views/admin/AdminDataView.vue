...
import { dialCodeForCountry, normalizeInternationalPhone, splitInternationalPhone } from '../../utils/phoneCodes'
      ...
      <section class="panel master-data-card">
        ...
        <div class="master-data-card-body student-card-body">
          <form class="form-grid student-admin-form" @submit.prevent="saveStudent">
            ...
            <div class="phone-input-group"><PhoneDialCodeSelect v-model="phoneDialCode" /><input v-model.trim="studentForm.phoneNumber" class="input" inputmode="tel" maxlength="24" placeholder="手机号码，可留空" /></div>
