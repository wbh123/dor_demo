...
const router = await readFile(new URL('./index.ts', import.meta.url), 'utf8')
const page = await readFile(new URL('../views/admin/AdminSystemReadinessView.vue', import.meta.url), 'utf8')
const operations = await readFile(new URL('../views/admin/AdminOperationsView.vue', import.meta.url), 'utf8')
