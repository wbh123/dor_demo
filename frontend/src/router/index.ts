  ...
  routes: [
    ...
    ...platformRoutes,
    {
      ...
      children: [
        ...
        { path: 'student/room-change', name: 'student-room-change', component: () => import('../views/student/StudentRoomChangeGateView.vue'), meta: { role: 'STUDENT' } },
        { path: 'student/waitlist', name: 'student-waitlist', component: () => import('../views/student/StudentWaitlistView.vue'), meta: { role: 'STUDENT' } },
        ...
        { path: 'admin/import-quality', name: 'admin-import-quality', component: () => import('../views/admin/AdminImportQualityView.vue'), meta: { role: 'ADMIN' } },
        ...
        { path: 'admin/governance', name: 'admin-governance', component: () => import('../views/admin/AdminGovernanceView.vue'), meta: { role: 'ADMIN' } },
