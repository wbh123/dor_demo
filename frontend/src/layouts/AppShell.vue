...
<template>
  <div class="app-shell fixed-navigation-shell">
    ...
    <main class="main-content fixed-sidebar-content" :class="{ 'student-main-content': auth.isStudent }">
      <section class="page-container" :class="{ 'student-page-container': auth.isStudent, 'admin-page-container': auth.isAdmin }"><RouterView v-if="!auth.welcomeRequired" /></section>
...
<style scoped>
.welcome-modal-heading{display:grid;gap:8px;width:100%;text-align:left}.welcome-modal-heading-row{display:flex;align-items:center;gap:14px}.welcome-modal-heading h2{margin:0;font-size:28px;line-height:1.25}.welcome-modal-heading .eyebrow{margin:0}.welcome-modal-content{display:grid;justify-items:stretch;gap:12px;text-align:left}.welcome-modal-message{margin:0;line-height:1.8;color:var(--text-muted)}
.fixed-navigation-shell{display:block;min-height:100vh}.fixed-sidebar{position:fixed;inset:0 auto 0 0;display:flex;flex-direction:column;width:260px;height:100vh;overflow:hidden;z-index:30}.fixed-sidebar .nav-list{min-height:0;overflow-y:auto;scrollbar-width:none}.fixed-sidebar .nav-list::-webkit-scrollbar{display:none}.fixed-sidebar .sidebar-foot{flex:0 0 auto}.sidebar-action-link{text-decoration:none;text-align:center}.fixed-sidebar-content{display:flex;flex-direction:column;min-height:100vh;margin-left:260px}.fixed-sidebar-content>.page-container{flex:1 0 auto}.school-brand{position:relative;z-index:5;isolation:isolate;display:flex;align-items:center;gap:12px;min-height:78px;padding:8px 12px;overflow:visible;background:linear-gradient(180deg,rgba(17,45,96,.98),rgba(17,45,96,.92))}.school-brand::before,.school-brand::after{pointer-events:none;z-index:0}.logo-safe-layer{position:relative;z-index:3;isolation:isolate}.school-brand-logo{position:relative;z-index:9;flex:0 0 auto;width:60px;height:60px;object-fit:contain;filter:drop-shadow(0 3px 8px rgba(0,0,0,.22))}.school-brand-title{position:relative;z-index:2;display:grid;gap:2px;min-width:0;text-align:left}.school-brand-title strong,.school-brand-title small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.school-brand-title strong{font-size:.92rem}.school-brand-title small{color:#91a8d5;font-size:.66rem}.admin-page-container{padding-top:22px}.account-card-without-avatar{padding:14px 16px}.account-card-without-avatar>div{min-width:0}.account-card-without-avatar strong,.account-card-without-avatar small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.page-compliance{display:flex;justify-content:center;gap:12px;flex-wrap:wrap;padding:18px 24px 22px;color:var(--muted);font-size:.72rem;line-height:1.45;text-align:center}.page-compliance span+span::before{content:"·";margin-right:12px}.welcome-school-logo{flex:0 0 auto;width:72px;height:72px;object-fit:contain}.welcome-start-button{min-width:180px}@media(max-width:820px){.fixed-sidebar{position:static;width:auto;height:auto;overflow:visible}.fixed-sidebar-content{margin-left:0}.school-brand{justify-content:flex-start}}
</style>
