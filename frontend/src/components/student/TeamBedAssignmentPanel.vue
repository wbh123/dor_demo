<script lang="ts">
export type { TeamMemberAssignment } from './teamSelectionTypes'
</script>
...
const props = defineProps<{ members: DataObject[]; beds: DataObject[]; memberAssignments: TeamMemberAssignment[]; disabled?: boolean }>()
