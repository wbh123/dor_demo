  ...
  <Teleport to="body">
    <Transition name="notice">
      <aside v-if="message" class="transient-notice" :class="type" role="status" aria-live="polite">
        <span class="notice-mark">{{ type === 'success' ? '✓' : type === 'error' ? '×' : type === 'warning' ? '!' : 'i' }}</span>
        <p>{{ message }}</p>
