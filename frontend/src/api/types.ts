...
export type BatchRuleTemplateCreateRequest = components['schemas']['BatchRuleTemplateCreateRequest']
export type BatchRuleTemplateRevisionRequest = components['schemas']['BatchRuleTemplateRevisionRequest']
