...
public class SystemSettingService {
    ...
    Map<String, String> normalizeLocaleMessages(Map<String, String> values) {
        return WelcomeMessageNormalizationSupport.normalizeLocaleMessages(
                values,
                PRIMARY_WELCOME_LOCALE,
                FALLBACK_WELCOME_LOCALE);
    }
    ...
    Map<String, String> normalizeCountryMessages(Map<String, String> values) {
        return WelcomeMessageNormalizationSupport.normalizeCountryMessages(values);
    }

    String normalizeLocaleTag(String value) {
        return WelcomeMessageNormalizationSupport.normalizeLocaleTag(value);
    }

    String normalizeCountryCode(String value) {
        return WelcomeMessageNormalizationSupport.normalizeCountryCode(value);
    }
