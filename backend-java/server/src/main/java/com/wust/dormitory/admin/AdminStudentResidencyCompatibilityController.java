...
/**
 * 兼容学生列表现有的修改寝室/床位交互路径。
 * 正式服务仍复用 AdminStudentResidencyAdjustmentService，避免出现两套业务规则。
 */
@RestController
@RequestMapping("/api/v1/admin/students/{studentId}")
public class AdminStudentResidencyCompatibilityController {
    private final AdminStudentResidencyAdjustmentService service;

    public AdminStudentResidencyCompatibilityController(
