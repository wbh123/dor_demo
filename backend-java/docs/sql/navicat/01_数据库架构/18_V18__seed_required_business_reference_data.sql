...
SELECT
    ...
    JSON_OBJECT(
        ...
        'sleepSensitivity',1.2,'noiseTolerance',1.2,
        'cleaningFrequency',1.0,'tidinessRequirement',1.0,
        'summerAirConditionerTemperature',0.8,'winterHeatingTemperature',0.6,
        'summerOvernightAirConditioner',1.1,'winterHeatingAcceptance',0.8,
        'afterLightsActivity',1.2,'alarmSnooze',0.9,
        'strongFoodOdorAcceptance',0.7,'ventilationPreference',0.6,
        'studyFrequency',0.8,'gamingVoiceFrequency',1.1,
        'socialActivity',0.6,'smokingAcceptance',2.0,'bedPreference',0.5
    ),
    JSON_OBJECT(
    ...
    1,0,NULL,'Flyway V18初始化系统默认匹配方案',CURRENT_TIMESTAMP(3)
