...
-- Source files: 1000_students_base.sql + 1000_students_realistic_mixed_state.sql
...
(student_id,notification_type,title_key,message_key,parameters_json,read_at,created_at)
